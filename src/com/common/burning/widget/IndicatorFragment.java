package com.common.burning.widget;
...
public class IndicatorFragment extends LinearLayout implements OnClickListener {
	...
	private IndicatorFragment(Context context) {
		super(context);
	}

	public IndicatorFragment(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.drawable.tab_home,
				R.string.tab_name, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
		mIndicators[0].setBackgroundResource(Color.alpha(0));
		mIndicators[0].setTag(Integer.valueOf(0));
		mIndicators[0].setOnClickListener(this);
		addView(mIndicators[0]);
		mIndicators[1] = createIndicator(R.drawable.tab_life,
				R.string.tab_name, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
		mIndicators[1].setBackgroundColor(Color.alpha(0));
		mIndicators[1].setTag(Integer.valueOf(1));
		mIndicators[1].setOnClickListener(this);
		addView(mIndicators[1]);
		mIndicators[2] = createIndicator(R.drawable.tab_user,
				R.string.tab_name, COLOR_UNSELECT, TAG_ICON_2, TAG_TEXT_2);
	...
	public static void setIndicator(int which) {
		...
		case 0:
			...
			prevIcon.setImageResource(R.drawable.tab_home);
		...
		case 1:
			...
			prevIcon.setImageResource(R.drawable.tab_life);
			prevText = (TextView) mIndicators[mCurIndicator]
		...
		case 2:
			...
			prevIcon.setImageResource(R.drawable.tab_user);
			prevText = (TextView) mIndicators[mCurIndicator]
		...
		case 0:
			currIcon = (ImageView) mIndicators[which]
					.findViewWithTag(TAG_ICON_0);
			currIcon.setImageResource(R.drawable.tab_home_p);
		...
		case 1:
			currIcon = (ImageView) mIndicators[which]
					.findViewWithTag(TAG_ICON_1);
			currIcon.setImageResource(R.drawable.tab_life_p);
			currText = (TextView) mIndicators[which]
					.findViewWithTag(TAG_TEXT_1);
			currText.setTextColor(COLOR_SELECT);
			break;
		case 2:
			currIcon = (ImageView) mIndicators[which]
					.findViewWithTag(TAG_ICON_2);
			currIcon.setImageResource(R.drawable.tab_user_p);
			currText = (TextView) mIndicators[which]
					.findViewWithTag(TAG_TEXT_2);
			currText.setTextColor(COLOR_SELECT);
			break;
